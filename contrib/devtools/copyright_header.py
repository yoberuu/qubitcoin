...
UPDATE_USAGE = """
Updates all the copyright headers of "Yelpful Technologies" which were
changed in a year more recent than is listed. For example:

// Copyright (c) <firstYear>-<lastYear> Yelpful Technologies

will be updated to:

// Copyright (c) <firstYear>-<lastModifiedYear> Yelpful Technologies

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> Yelpful Technologies

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> Yelpful Technologies
...
CPP_HEADER = '''
// Copyright (c) %s Yelpful Technologies
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by Yelpful Technologies'
                 % (filename))
...
INSERT_USAGE = """
Inserts a copyright header for "Yelpful Technologies" at the top of the
...
If the file already has a copyright for "Yelpful Technologies", the
script will exit.
