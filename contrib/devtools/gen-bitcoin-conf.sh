...
BITCOIND=${BITCOIND:-$BINDIR/qbitcoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/qubitcoin.conf}
...
then
  ...
  echo -e "To safely generate a qubitcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example qubitcoin.conf file in share/examples/'
