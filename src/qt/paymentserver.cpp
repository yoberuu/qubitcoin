...
const QString QUBITCOIN_IPC_PREFIX("qubitcoin:");
...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(QUBITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // qubitcoin: URI
        {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("qubitcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'qubitcoin://' is not a valid URI. Use 'qubitcoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(QUBITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // qubitcoin: URI
    {
