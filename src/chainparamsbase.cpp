...
/**
 * Port numbers for incoming Tor connections (2097, 12097, 32097, 42097, 21097) have
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 2095, 2097);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 12095, 12097);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 42095, 42097);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 32095, 32097);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 21095, 21097);
    }
    assert(false);
}
