...
{
    argsman.AddArg("-addresstype", strprintf("What type of addresses to use (\"dilithium\", \"legacy\", \"p2sh-segwit\", \"bech32\", or \"bech32m\", default: \"%s\"). On QubitCoin only \"dilithium\" can be spent; legacy wallets default to dilithium automatically.", FormatOutputType(DEFAULT_ADDRESS_TYPE)), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    argsman.AddArg("-changetype",
                   "What type of change to use (\"dilithium\", \"legacy\", \"p2sh-segwit\", \"bech32\", or \"bech32m\"). "
                   "Legacy wallets default to \"dilithium\". Only \"dilithium\" change can be spent on QubitCoin.",
